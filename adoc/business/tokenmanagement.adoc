...
The metadata is loosely based on a combination of the ERC721 (https://github.com/ethereum/EIPs/blob/master/EIPS/eip-721.md) and ERC1155 (https://github.com/ethereum/EIPs/blob/master/EIPS/eip-1155.md) and it's goal is to be compatible with most metadata standards.
...
operation::update-token-metadata[snippets='curl-request,path-parameters,request-fields,http-response']
