...
The sample code used during this guide can either be https://github.com/ArkaneNetwork/Arketype/archive/master.zip[download] or https://github.com/ArkaneNetwork/Arketype[explored] on GitHub.
