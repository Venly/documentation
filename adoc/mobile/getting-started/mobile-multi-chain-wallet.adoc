...
The sample code used during this guide can either be https://github.com/ArkaneNetwork/mobile-android-example/archive/master.zip[download] or https://github.com/ArkaneNetwork/mobile-android-example[explored] on GitHub.
