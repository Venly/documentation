...
=== Fetch balance
<<<<<<< HEAD
To fetch the balance of a wallet, simply view the details of the wallet since it will return the balance:
=======
To fetch the balance of a wallet, simply get the details of the wallet since it will return the balance:
>>>>>>> f6b94ecd320ef8abc2d6e000ebb648d6d0f96232

 GET https://api-staging.arkane.network/api/wallets/{id}
...
|dec19db8-8b6e-4cdb-8452-886a3a44e364

|===

[REFERENCE]
====
Reference: https://docs-staging.arkane.network/pages/rest-api-public#_get_a_specific_user_wallet
====
<<<<<<< HEAD
=======

=== Fetch token balances
To fetch the balance of all supported tokens on Arkane, use API endpoint:

 GET https://api-staging.arkane.network/api/wallets/{id}/balance/tokens
...
[REFERENCE]
====
Reference: http:///pages/rest-api-public#_get_the_balance_of_all_tokens_for_a_specific_user_wallet[/pages/rest-api-public#_get_the_balance_of_all_tokens_for_a_specific_user_wallet]
====

=== Fetch specific token balance
To fetch the balance for a specific token and wallet:

 GET https://api-staging.arkane.network/api/wallets/{id}/balance/tokens/{token}
...
[REFERENCE]
====
Reference: http:///pages/rest-api-public#_get_the_balance_of_a_token_for_a_specific_user_wallet[/pages/rest-api-public#_get_the_balance_of_a_token_for_a_specific_user_wallet]
====
>>>>>>> f6b94ecd320ef8abc2d6e000ebb648d6d0f96232
...
To execute a transfer, an API endpoint is availble to "build" the transaction request:

 POST https://api-staging.arkane.network/api/transactions/build

Here is an example of the expected body of the request (application/json), this will build a transaction request for transferring 1 ETH:

[source,javascript]
----
{
  "walletId" : dec19db8-8b6e-4cdb-8452-886a3a44e364,
...
[NOTE]
====
If you want to perform a token transfer, add the field "tokenAddress".
====
...
[REFERENCE]
====
Reference: http:///pages/rest-api-public#_build_a_transaction_request[/pages/rest-api-public#_build_a_transaction_request]
====

With the result of this call, you can submit it as a link:#execute-native-transaction["native transaction]".


[[execute-native-transaction]]
=== Execute native transaction

To execute a native transaction, it will be necessary to open a browser to have the user sign the transaction.

So from the app we need to open a custom tab with the URL:

 GET https://connect-staging.arkane.network/transaction/execute?redirectUri={redirectUri}&bearerToken={bearerToken}&data={data}
...
|data
|Base64 encoded json object containing a generic transaction request you would like to sign/submit. This object is specific for each chain. (This can be the result of building a <<transfer>>).
|eyJ3YWxsZXRJZCI6ImFmMzVlNTA0L
WQ4ZjctNGZjMi05YzFjLTQyODM2NjI4Nzlk
MyIsInRvIjoiMHg2ODA4MDBEZDQ5MTMwM
jE4MjFBOUMwOEQ1NjllRjQzMzhkQjhFO
WY2IiwidmFsdWUiOjAuMDMxNCwic2Vj
cmV0VHlwZSI6IkVUSEVSRVVNIn0=
...
[REFERENCE]
====
Reference (ex. Ethereum): http:///pages/rest-api-public#_ethereum[/pages/rest-api-public#_ethereum]
====
