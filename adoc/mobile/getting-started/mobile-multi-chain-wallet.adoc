...
In this example, the following components are used link:buildingblocks#_arkane_identity[[.bb-identity]#Arkane Identity#] link:buildingblocks#_arkane_api[[.bb-api]#Arkane API#] link:buildingblocks#_arkane_connect[[.bb-connect]#Arkane Connect#].
