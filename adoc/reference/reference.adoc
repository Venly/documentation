...
|outputs
|It is possible to add additional asset transfers together with a contract call by attaching additional outputs. This is a JSON object containing "to", "amount" and "assetId".
|
{
"to": "AKJrLM5QCdr8opd1JZhYWnHZrBJbz6rbXv",
"amount": 1,
