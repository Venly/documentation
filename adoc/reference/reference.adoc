...
[NOTE]
====
Currently this functionallity is only supported for Ethereum, other chains will follow
====

=== [[nft-get-for-address]] List the NFT's of an address link:buildingblocks.html#_arkane_api[[.bb-api]#Arkane API#]
Returns the list of NFT's owned by the given address
