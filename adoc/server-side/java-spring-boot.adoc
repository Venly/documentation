...
In this example, the following components will be used link:buildingblocks#_arkane_identity[[.bb-identity]#Arkane Identity#] link:buildingblocks#_arkane_api[[.bb-api]#Arkane API#].
...
In this example, the following components were used link:buildingblocks#_arkane_identity[[.bb-identity]#Arkane Identity#] link:buildingblocks#_arkane_api[[.bb-api]#Arkane API#].
